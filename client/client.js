window.__ModuleLoader__.load({ id: "dshmarket", factory: (require) => {
		...
		*/
		...
		const css = ".I-Nqna_root{min-width:0;height:100%;color:var(--dsw-alias-label-primary,#1f2328);flex-direction:column;display:flex;position:relative}.I-Nqna_head{flex-direction:column;gap:12px;padding:4px 4px 12px;display:flex}.I-Nqna_title{margin:0;font-size:16px;font-weight:500;line-height:24px}.I-Nqna_sub{color:var(--dsw-alias-label-tertiary,#8b93a1);align-items:center;gap:8px;margin:0;font-size:14px;line-height:22px;display:flex}.I-Nqna_tabs{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:flex-end;gap:2px;display:flex}.I-Nqna_tab{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;white-space:nowrap;background:0 0;border:none;border-bottom:2px solid #0000;padding:7px 12px;font-size:13px}.I-Nqna_tab.I-Nqna_on{color:var(--dsw-alias-brand-primary,#4f6ef7);border-bottom-color:var(--dsw-alias-brand-primary,#4f6ef7);font-weight:600}.I-Nqna_banner{background:var(--dsw-alias-bg-layer-2,#fdf3e3);border:1px solid var(--dsw-alias-border-l2,#f3e3c3);border-radius:8px;align-items:center;gap:8px;margin:0;padding:8px 12px;font-size:12px;display:flex}.I-Nqna_bannerIcon{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0}.I-Nqna_bannerHint{color:var(--dsw-alias-label-tertiary,#8b93a1);cursor:help;display:inline-flex}.I-Nqna_body{flex:1;padding:12px 4px 24px;overflow-x:hidden;overflow-y:auto}.I-Nqna_cats{z-index:5;background:var(--dsw-alias-bg-layer-2,#f7f8fa);margin:-12px -4px 2px;padding:12px 4px 4px;position:sticky;top:-13px}.I-Nqna_catsRow{align-items:flex-start;gap:8px;display:flex;position:relative}.I-Nqna_star{color:var(--dsw-alias-label-secondary,#9ca3af);font-size:11px}.I-Nqna_top{z-index:20;display:inline-flex;position:absolute;bottom:18px;right:18px}.I-Nqna_topBtn{border-radius:99px;width:38px;height:38px;padding:0}.I-Nqna_tag{border:1px solid var(--dsw-alias-border-l3,#d9dde3);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:4px;flex-shrink:0;padding:1px 6px;font-size:11px;line-height:16px}.I-Nqna_okState{color:var(--dsw-alias-state-success-primary,#16a34a);white-space:nowrap;font-size:12px;font-weight:600}.I-Nqna_catsWrap{flex-wrap:wrap;flex:1;align-items:center;gap:6px;min-width:0;display:flex}.I-Nqna_catsCollapsed{max-height:62px;overflow:hidden}.I-Nqna_catsToggle.I-Nqna_catsToggle{height:26px;min-height:26px;color:var(--dsw-alias-label-secondary,#6b7280);padding:0 6px}.I-Nqna_shots{-webkit-overflow-scrolling:touch;scrollbar-width:thin;gap:8px;margin:0 0 8px;padding:2px 0 6px;display:flex;overflow-x:auto}.I-Nqna_shot{object-fit:cover;border:1px solid var(--dsw-alias-border-default,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f3f4f6);border-radius:8px;flex:none;max-width:260px;height:150px}.I-Nqna_cmd{background:var(--dsw-alias-bg-layer-2,#f3f4f6);word-break:break-all;border-radius:6px;margin:8px 0 0;padding:8px 10px;font-family:ui-monospace,Menlo,monospace;font-size:11px;line-height:18px}.I-Nqna_warnLine{color:var(--dsw-alias-state-warn-primary,#b45309);align-items:center;gap:4px;margin:0;font-size:12px;font-weight:600;line-height:18px;display:flex}.I-Nqna_modalNote{color:var(--dsw-alias-label-tertiary,#8b93a1);align-items:center;gap:4px;margin:12px 0 0;font-size:12px;line-height:18px;display:flex}.I-Nqna_grid{grid-template-columns:repeat(auto-fill,minmax(280px,1fr));gap:12px;display:grid}.I-Nqna_swatches{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;gap:0;height:34px;display:flex;overflow:hidden}.I-Nqna_themesGrid{margin-bottom:12px}.I-Nqna_swatches i{flex:1}.I-Nqna_card{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;gap:12px;padding:12px 14px;display:flex}.I-Nqna_row1{align-items:center;gap:10px;min-width:0;display:flex}.I-Nqna_srcBtn{flex-shrink:0;align-self:flex-start}.I-Nqna_av{color:#fff;object-fit:cover;background:var(--dsw-alias-bg-layer-2,#f3f4f6);border-radius:8px;flex-shrink:0;place-items:center;width:32px;height:32px;font-size:14px;font-weight:700;display:grid}.I-Nqna_nm{text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:500;line-height:22px;overflow:hidden}.I-Nqna_owner{color:var(--dsw-alias-label-secondary,#9ca3af);font-size:11px}.I-Nqna_desc{color:var(--dsw-alias-label-tertiary,#8b93a1);min-height:36px;margin:0;font-size:12px;line-height:18px}.I-Nqna_foot{align-items:center;gap:8px;margin-top:auto;display:flex}.I-Nqna_grow{flex:1}.I-Nqna_titleRow{align-items:center;gap:10px;display:flex}.I-Nqna_version{color:var(--dsw-alias-label-tertiary,#8b93a1);font-variant-numeric:tabular-nums;flex-shrink:0;font-size:12px;line-height:20px}.I-Nqna_descTight{min-height:0}.I-Nqna_src{color:var(--dsw-alias-label-secondary,#9ca3af);font-size:11px;text-decoration:none}.I-Nqna_src:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.I-Nqna_dot{vertical-align:2px;margin-left:5px}.I-Nqna_act{flex-wrap:wrap;align-items:center;gap:6px;margin-top:6px;font-size:11px;display:flex}.I-Nqna_actLive{color:var(--dsw-alias-state-success-primary,#16a34a);align-items:center;gap:4px;font-weight:600;display:inline-flex}.I-Nqna_actWarn{color:var(--dsw-alias-state-warn-primary,#b45309);align-items:center;gap:4px;font-weight:600;display:inline-flex}.I-Nqna_actBroken{color:var(--dsw-alias-state-error-primary,#dc2626);align-items:center;gap:4px;font-weight:600;display:inline-flex}.I-Nqna_actWhy{color:var(--dsw-alias-label-secondary,#6b7280);margin-top:2px}.I-Nqna_loading{color:var(--dsw-alias-label-secondary,#9ca3af);flex-direction:column;align-items:center;gap:12px;padding:48px;font-size:13px;display:flex}.I-Nqna_spin{color:var(--dsw-alias-brand-primary,#4f6ef7);flex-shrink:0;animation:.8s linear infinite I-Nqna_sp;display:inline-flex}@keyframes I-Nqna_sp{to{transform:rotate(360deg)}}.I-Nqna_progress{background:var(--dsw-alias-bg-layer-2,#f3f4f6);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:8px;flex-wrap:wrap;align-items:center;gap:9px;margin:0;padding:8px 12px;font-size:12px;display:flex}.I-Nqna_bar{background:var(--dsw-alias-border-l1,#e5e7eb);border-radius:99px;width:100%;height:4px;overflow:hidden}.I-Nqna_barFill{background:var(--dsw-alias-brand-primary,#4f6ef7);border-radius:99px;height:100%;transition:width .6s}.I-Nqna_barWave{width:30%;animation:1.2s ease-in-out infinite I-Nqna_dshmSlide}@keyframes I-Nqna_dshmSlide{0%{margin-left:-30%}to{margin-left:100%}}.I-Nqna_irow .I-Nqna_progress{margin-top:8px}.I-Nqna_progress code{text-overflow:ellipsis;white-space:nowrap;font-family:ui-monospace,Menlo,monospace;font-size:11px;overflow:hidden}.I-Nqna_empty{color:var(--dsw-alias-label-secondary,#9ca3af);text-align:center;padding:32px;font-size:13px}.I-Nqna_err{color:var(--dsw-alias-state-error-primary,#dc2626);white-space:pre-wrap;word-break:break-all;margin:8px 0;font-size:12px}.I-Nqna_irow{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;align-items:center;gap:10px;margin-bottom:8px;padding:12px 14px;display:flex}.I-Nqna_irowMissing{filter:grayscale();opacity:.5}.I-Nqna_irow>.I-Nqna_src,.I-Nqna_irow>.I-Nqna_owner,.I-Nqna_irow button{white-space:nowrap;flex-shrink:0}.I-Nqna_tabSearchRow{padding:0 4px 10px;display:flex}.I-Nqna_tabSearch{width:260px}.I-Nqna_spec{color:var(--dsw-alias-label-secondary,#9ca3af);overflow-wrap:anywhere;min-width:0;font-family:ui-monospace,Menlo,monospace;font-size:11px}.I-Nqna_specTag{white-space:nowrap;border-radius:4px;flex-shrink:0;align-items:center;height:16px;padding:0 5px;font-size:10px;font-weight:600;display:inline-flex}.I-Nqna_specTagGit{color:#0b7285;background:#12a3c41f}.I-Nqna_specTagFile{color:#b07d1b;background:#f0b42924}.I-Nqna_backupCheckList .I-Nqna_grow{white-space:nowrap;text-overflow:ellipsis;flex:70%;min-width:0;overflow:hidden}.I-Nqna_backupCheckList .I-Nqna_spec{text-align:right;white-space:nowrap;text-overflow:ellipsis;flex:0 30%;max-width:30%;overflow:hidden}.I-Nqna_staleAction{margin-top:8px}.I-Nqna_pct{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0;font-size:11px;font-weight:600}.I-Nqna_pager{flex-wrap:wrap;justify-content:space-between;align-items:center;gap:12px;margin:16px 0 4px;display:flex}.I-Nqna_pagerPages{flex-wrap:wrap;flex:1;justify-content:center;align-items:center;gap:6px;min-width:0;display:flex}.I-Nqna_pageEllipsis{color:var(--dsw-alias-label-secondary,#9ca3af);padding:0 2px;font-size:12px}.I-Nqna_pageInfo{color:var(--dsw-alias-label-secondary,#6b7280);white-space:nowrap;font-size:12px}.I-Nqna_depBadge{border:1px solid var(--dsw-alias-state-warn-primary,#b45309);color:var(--dsw-alias-state-warn-primary,#b45309);white-space:nowrap;border-radius:4px;flex-shrink:0;margin-left:6px;padding:1px 6px;font-size:11px;font-weight:600;line-height:16px}.I-Nqna_deprecate{color:var(--dsw-alias-state-warn-primary,#b45309);background:var(--dsw-alias-bg-layer-2,#fdf3e3);border:1px solid var(--dsw-alias-border-l2,#f3e3c3);border-radius:8px;margin:0;padding:8px 10px;font-size:12px;line-height:18px}.I-Nqna_deprecate a{color:var(--dsw-alias-state-warn-primary,#b45309);text-decoration:underline}.I-Nqna_deprecate .I-Nqna_src{margin-left:8px}.I-Nqna_depLine{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.I-Nqna_switch{border:1px solid var(--dsw-alias-border-l2,#d9dde3);background:var(--dsw-alias-bg-layer-2,#e5e7eb);cursor:pointer;border-radius:99px;flex-shrink:0;width:38px;height:22px;padding:0;transition:background .15s,border-color .15s;position:relative}.I-Nqna_switchOn{background:var(--dsw-alias-state-success-primary,#16a34a);border-color:var(--dsw-alias-state-success-primary,#16a34a)}.I-Nqna_switchMixed{background:var(--dsw-alias-state-warn-primary,#b45309);border-color:var(--dsw-alias-state-warn-primary,#b45309)}.I-Nqna_switchKnob{background:#fff;border-radius:99px;width:16px;height:16px;transition:left .15s;position:absolute;top:2px;left:2px;box-shadow:0 1px 2px #00000040}.I-Nqna_switchOn .I-Nqna_switchKnob,.I-Nqna_switchMixed .I-Nqna_switchKnob{left:18px}.I-Nqna_switch:disabled{opacity:.5;cursor:default}.I-Nqna_viewBar{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;align-items:center;gap:2px;width:fit-content;margin-bottom:12px;padding:2px;display:flex}.I-Nqna_viewBtn{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;white-space:nowrap;background:0 0;border:none;border-radius:6px;padding:4px 10px;font-size:12px;line-height:18px}.I-Nqna_viewBtn:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.I-Nqna_viewOn{background:var(--dsw-alias-bg-layer-2,#eef0f4);color:var(--dsw-alias-label-primary,#1f2328);font-weight:600}.I-Nqna_groupRow{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;margin-bottom:10px;padding:12px 14px}.I-Nqna_groupHead{align-items:center;gap:10px;min-width:0;display:flex}.I-Nqna_groupName{text-overflow:ellipsis;white-space:nowrap;font-size:13px;font-weight:600;line-height:20px;overflow:hidden}.I-Nqna_groupActions{flex-shrink:0;align-items:center;gap:6px;display:flex}.I-Nqna_groupMembers{flex-direction:column;gap:6px;margin-top:10px;display:flex}.I-Nqna_groupMember{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;align-items:center;gap:8px;padding:6px 8px;font-size:12px;line-height:18px;display:flex}.I-Nqna_groupMember .I-Nqna_nm{flex:1;min-width:0;font-size:12px}.I-Nqna_groupAddPanel{border-top:1px dashed var(--dsw-alias-border-l2,#e5e7eb);flex-direction:column;gap:6px;margin-top:10px;padding-top:10px;display:flex}.I-Nqna_groupCreate{align-items:center;gap:8px;margin-bottom:10px;display:flex}.I-Nqna_inlineInput{flex:1;min-width:120px}.I-Nqna_assignRow{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.I-Nqna_assignSelect{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-1,#fff);color:var(--dsw-alias-label-primary,#1f2328);font:inherit;border-radius:6px;padding:3px 6px;font-size:12px;line-height:18px}.I-Nqna_groupHint{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:11px}.I-Nqna_sectAction{color:var(--dsw-alias-label-secondary,#6b7280);align-items:center;gap:8px;margin:14px 2px 8px;font-size:12px;font-weight:600;display:flex}.I-Nqna_backupGrid{grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:12px;display:grid}.I-Nqna_backupCard{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;gap:10px;padding:16px;display:flex}.I-Nqna_backupCard h3{margin:0;font-size:14px}.I-Nqna_backupCard p{color:var(--dsw-alias-label-secondary,#6b7280);margin:0;font-size:12px;line-height:18px}.I-Nqna_backupActions{flex-wrap:wrap;gap:8px;display:flex;position:relative}.I-Nqna_hiddenFile{opacity:0;pointer-events:none;width:1px;height:1px;position:absolute}.I-Nqna_backupInput{box-sizing:border-box;width:100%}.I-Nqna_backupCheck{cursor:pointer;align-items:center;gap:6px;font-size:12px;display:flex}.I-Nqna_backupWarn{margin:0;font-size:12px;line-height:18px;color:var(--dsw-alias-state-warn-primary,#b45309)!important}.I-Nqna_backupMessage{color:var(--dsw-alias-label-secondary,#6b7280);grid-column:1/-1;font-size:12px}.I-Nqna_backupCheckList{flex-direction:column;gap:6px;max-height:260px;margin:10px 0 4px;padding-right:4px;display:flex;overflow-y:auto}.I-Nqna_backupCheckList .I-Nqna_backupCheck{justify-content:space-between;gap:8px}.I-Nqna_diagPage{flex-direction:column;gap:12px;height:100%;min-height:0;display:flex;overflow-y:auto}.I-Nqna_diagSummary{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-wrap:wrap;align-items:center;gap:12px;padding:10px 14px;font-size:12px;display:flex}.I-Nqna_diagSummaryItem{color:var(--dsw-alias-label-secondary,#6b7280);white-space:nowrap;align-items:center;gap:6px;display:inline-flex}.I-Nqna_diagSummaryMeta{color:var(--dsw-alias-label-tertiary,#9ca3af);text-overflow:ellipsis;white-space:nowrap;max-width:320px;font-family:ui-monospace,Menlo,monospace;font-size:11px;overflow:hidden}.I-Nqna_diagSection{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;gap:8px;padding:12px 14px;display:flex}.I-Nqna_diagSection h3{color:var(--dsw-alias-label-primary,#1f2328);margin:0;font-size:13px;font-weight:600}.I-Nqna_diagCount{color:var(--dsw-alias-label-tertiary,#9ca3af);font-size:11px;font-weight:400}.I-Nqna_diagEmpty{color:var(--dsw-alias-label-secondary,#9ca3af);padding:8px 0;font-size:12px}.I-Nqna_diagBundle{border-top:1px solid var(--dsw-alias-border-l2,#f0f1f3);flex-direction:column;gap:6px;padding-top:8px;display:flex}.I-Nqna_diagBundle:first-of-type{border-top:none;padding-top:0}.I-Nqna_diagRow{flex-wrap:wrap;align-items:center;gap:8px;min-width:0;font-size:12px;line-height:18px;display:flex}.I-Nqna_diagMeta{align-items:baseline;gap:8px;min-width:0;font-size:12px;display:flex}.I-Nqna_diagKey{color:var(--dsw-alias-label-tertiary,#9ca3af);flex-shrink:0;min-width:64px;font-size:11px}.I-Nqna_diagVal{color:var(--dsw-alias-label-primary,#1f2328);overflow-wrap:anywhere;min-width:0;font-family:ui-monospace,Menlo,monospace;font-size:12px;font-weight:500}.I-Nqna_diagIndex{background:var(--dsw-alias-bg-layer-2,#f3f4f6);min-width:18px;height:18px;color:var(--dsw-alias-label-secondary,#6b7280);border-radius:9px;flex-shrink:0;justify-content:center;align-items:center;font-size:11px;font-weight:600;display:inline-flex}.I-Nqna_diagArrow{color:var(--dsw-alias-label-tertiary,#9ca3af);flex-shrink:0;font-size:12px}.I-Nqna_diagBadgeOfficial{background:var(--dsw-alias-brand-primary,#4f6ef7);color:#fff;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.I-Nqna_diagBadgeCommunity{background:var(--dsw-alias-bg-layer-2,#f3f4f6);height:18px;color:var(--dsw-alias-label-secondary,#6b7280);border-radius:9px;flex-shrink:0;align-items:center;padding:0 8px;font-size:11px;display:inline-flex}.I-Nqna_diagBadgeShadow{background:var(--dsw-alias-state-error-primary,#dc2626);color:#fff;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.I-Nqna_diagList{flex-direction:column;gap:6px;display:flex}.I-Nqna_sectionOverview{color:var(--dsw-alias-label-tertiary,#8b93a1);text-overflow:ellipsis;white-space:nowrap;max-width:100%;padding:2px 0 6px;font-size:12px;line-height:18px;overflow:hidden}.I-Nqna_diagAlert{color:var(--dsw-alias-state-warn-primary,#b45309)}.I-Nqna_ovRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-wrap:wrap;align-items:center;gap:8px;min-width:0;padding:6px 10px;font-size:12px;line-height:18px;display:flex}.I-Nqna_ovArrow{color:var(--dsw-alias-label-tertiary,#9ca3af);flex-shrink:0;font-size:12px}.I-Nqna_ovByTag{background:var(--dsw-alias-brand-primary,#4f6ef7);color:#fff;text-overflow:ellipsis;white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;max-width:260px;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex;overflow:hidden}.I-Nqna_ovFrom{color:var(--dsw-alias-label-secondary,#6b7280);text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:12px;overflow:hidden}.I-Nqna_orphRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-wrap:wrap;align-items:center;gap:8px;min-width:0;padding:6px 10px;font-size:12px;line-height:18px;display:flex}.I-Nqna_orphBadge{background:var(--dsw-alias-state-warn-primary,#b45309);color:#fff;white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.I-Nqna_dragHandle{width:20px;height:20px;color:var(--dsw-alias-label-tertiary,#9ca3af);cursor:grab;-webkit-user-select:none;user-select:none;flex-shrink:0;justify-content:center;align-items:center;font-size:12px;line-height:20px;display:inline-flex}.I-Nqna_dragOver{outline:2px dashed var(--dsw-alias-brand-primary,#4f6ef7);outline-offset:2px;background:var(--dsw-alias-bg-layer-2,#f0f2f8);border-radius:8px}.I-Nqna_dragging{opacity:.45;background:var(--dsw-alias-bg-layer-2,#f3f4f6)}.I-Nqna_collapseHead{font:inherit;color:var(--dsw-alias-label-primary,#1f2328);cursor:pointer;text-align:left;background:0 0;border:none;align-items:center;gap:8px;width:100%;padding:0;font-size:13px;font-weight:600;display:flex}.I-Nqna_collapseIcon{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0;display:inline-flex}.I-Nqna_collapseTitle{flex:1;min-width:0}.I-Nqna_collapseBody{border-top:1px solid var(--dsw-alias-border-l2,#f0f1f3);overflow-wrap:anywhere;flex-direction:column;gap:10px;min-width:0;margin-top:8px;padding-top:10px;display:flex}.I-Nqna_panelNote{color:var(--dsw-alias-label-secondary,#6b7280);margin:0;font-size:12px;line-height:18px}.I-Nqna_fixFallback{flex-direction:column;gap:6px;margin:8px 0;display:flex}.I-Nqna_fixFallbackText{box-sizing:border-box;width:100%;color:var(--dsw-alias-label-primary,#1f2328);background:var(--dsw-alias-bg-layer-2,#f3f4f6);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);resize:vertical;white-space:pre-wrap;word-break:break-all;border-radius:6px;padding:8px 10px;font-family:ui-monospace,Menlo,monospace;font-size:11px;line-height:16px}.I-Nqna_setCard{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;gap:14px;padding:16px 18px;display:flex}.I-Nqna_setHead{flex-direction:column;gap:4px;display:flex}.I-Nqna_setTitle{font-size:15px;font-weight:600;line-height:22px}.I-Nqna_setDesc{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:13px;line-height:20px}.I-Nqna_setRow{align-items:flex-start;gap:12px;display:flex}.I-Nqna_setLabelBox{flex-direction:column;flex:1;gap:3px;min-width:0;display:flex}.I-Nqna_setLabel{font-size:13px;line-height:20px}.I-Nqna_setHint{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:12px;line-height:18px}.I-Nqna_setRevert{font:inherit;color:var(--dsw-alias-brand-primary,#4f6ef7);cursor:pointer;background:0 0;border:none;flex-shrink:0;padding:0;font-size:12px}.I-Nqna_setRevert:disabled{color:var(--dsw-alias-label-tertiary,#8b93a1);cursor:default}";
		...
		var Market_module_css_default = {
			"fixFallbackText": "I-Nqna_fixFallbackText",
			"depBadge": "I-Nqna_depBadge",
			"src": "I-Nqna_src",
			"diagPage": "I-Nqna_diagPage",
			"switchMixed": "I-Nqna_switchMixed",
			"diagSummary": "I-Nqna_diagSummary",
			"backupGrid": "I-Nqna_backupGrid",
			"title": "I-Nqna_title",
			"diagBadgeOfficial": "I-Nqna_diagBadgeOfficial",
			"diagAlert": "I-Nqna_diagAlert",
			"setRow": "I-Nqna_setRow",
			"progress": "I-Nqna_progress",
			"dragHandle": "I-Nqna_dragHandle",
			"cats": "I-Nqna_cats",
			"empty": "I-Nqna_empty",
			"banner": "I-Nqna_banner",
			"groupMembers": "I-Nqna_groupMembers",
			"hiddenFile": "I-Nqna_hiddenFile",
			"diagBadgeShadow": "I-Nqna_diagBadgeShadow",
			"ovRow": "I-Nqna_ovRow",
			"root": "I-Nqna_root",
			"collapseBody": "I-Nqna_collapseBody",
			"fixFallback": "I-Nqna_fixFallback",
			"err": "I-Nqna_err",
			"viewOn": "I-Nqna_viewOn",
			"barWave": "I-Nqna_barWave",
			"spin": "I-Nqna_spin",
			"groupCreate": "I-Nqna_groupCreate",
			"sectAction": "I-Nqna_sectAction",
			"catsWrap": "I-Nqna_catsWrap",
			"av": "I-Nqna_av",
			"sub": "I-Nqna_sub",
			"cmd": "I-Nqna_cmd",
			"specTagFile": "I-Nqna_specTagFile",
			"shot": "I-Nqna_shot",
			"diagArrow": "I-Nqna_diagArrow",
			"card": "I-Nqna_card",
			"groupHint": "I-Nqna_groupHint",
			"staleAction": "I-Nqna_staleAction",
			"titleRow": "I-Nqna_titleRow",
			"diagSummaryMeta": "I-Nqna_diagSummaryMeta",
			"backupCheckList": "I-Nqna_backupCheckList",
			"pagerPages": "I-Nqna_pagerPages",
			"ovFrom": "I-Nqna_ovFrom",
			"switch": "I-Nqna_switch",
			"panelNote": "I-Nqna_panelNote",
			"diagCount": "I-Nqna_diagCount",
			"top": "I-Nqna_top",
			"diagSummaryItem": "I-Nqna_diagSummaryItem",
			"spec": "I-Nqna_spec",
			"setCard": "I-Nqna_setCard",
			"switchOn": "I-Nqna_switchOn",
			"orphBadge": "I-Nqna_orphBadge",
			"diagSection": "I-Nqna_diagSection",
			"setTitle": "I-Nqna_setTitle",
			"specTagGit": "I-Nqna_specTagGit",
			"bannerHint": "I-Nqna_bannerHint",
			"swatches": "I-Nqna_swatches",
			"setHint": "I-Nqna_setHint",
			"diagBadgeCommunity": "I-Nqna_diagBadgeCommunity",
			"specTag": "I-Nqna_specTag",
			"head": "I-Nqna_head",
			"star": "I-Nqna_star",
			"actLive": "I-Nqna_actLive",
			"collapseHead": "I-Nqna_collapseHead",
			"topBtn": "I-Nqna_topBtn",
			"loading": "I-Nqna_loading",
			"actWarn": "I-Nqna_actWarn",
			"version": "I-Nqna_version",
			"nm": "I-Nqna_nm",
			"collapseIcon": "I-Nqna_collapseIcon",
			"depLine": "I-Nqna_depLine",
			"catsToggle": "I-Nqna_catsToggle",
			"themesGrid": "I-Nqna_themesGrid",
			"diagList": "I-Nqna_diagList",
			"collapseTitle": "I-Nqna_collapseTitle",
			"bannerIcon": "I-Nqna_bannerIcon",
			"on": "I-Nqna_on",
			"tabSearchRow": "I-Nqna_tabSearchRow",
			"groupHead": "I-Nqna_groupHead",
			"pageInfo": "I-Nqna_pageInfo",
			"actWhy": "I-Nqna_actWhy",
			"actBroken": "I-Nqna_actBroken",
			"dshmSlide": "I-Nqna_dshmSlide",
			"diagEmpty": "I-Nqna_diagEmpty",
			"setLabelBox": "I-Nqna_setLabelBox",
			"tag": "I-Nqna_tag",
			"shots": "I-Nqna_shots",
			"modalNote": "I-Nqna_modalNote",
			"srcBtn": "I-Nqna_srcBtn",
			"pct": "I-Nqna_pct",
			"grow": "I-Nqna_grow",
			"irow": "I-Nqna_irow",
			"pager": "I-Nqna_pager",
			"foot": "I-Nqna_foot",
			"switchKnob": "I-Nqna_switchKnob",
			"backupWarn": "I-Nqna_backupWarn",
			"backupActions": "I-Nqna_backupActions",
			"diagKey": "I-Nqna_diagKey",
			"backupMessage": "I-Nqna_backupMessage",
			"dragOver": "I-Nqna_dragOver",
			"setDesc": "I-Nqna_setDesc",
			"backupInput": "I-Nqna_backupInput",
			"tab": "I-Nqna_tab",
			"deprecate": "I-Nqna_deprecate",
			"setRevert": "I-Nqna_setRevert",
			"viewBtn": "I-Nqna_viewBtn",
			"tabSearch": "I-Nqna_tabSearch",
			"bar": "I-Nqna_bar",
			"okState": "I-Nqna_okState",
			"groupRow": "I-Nqna_groupRow",
			"grid": "I-Nqna_grid",
			"inlineInput": "I-Nqna_inlineInput",
			"setHead": "I-Nqna_setHead",
			"viewBar": "I-Nqna_viewBar",
			"irowMissing": "I-Nqna_irowMissing",
			"groupActions": "I-Nqna_groupActions",
			"act": "I-Nqna_act",
			"catsRow": "I-Nqna_catsRow",
			"backupCheck": "I-Nqna_backupCheck",
			"groupMember": "I-Nqna_groupMember",
			"diagBundle": "I-Nqna_diagBundle",
			"diagRow": "I-Nqna_diagRow",
			"diagIndex": "I-Nqna_diagIndex",
			"tabs": "I-Nqna_tabs",
			"sectionOverview": "I-Nqna_sectionOverview",
			"orphRow": "I-Nqna_orphRow",
			"dragging": "I-Nqna_dragging",
			"diagVal": "I-Nqna_diagVal",
			"pageEllipsis": "I-Nqna_pageEllipsis",
			"body": "I-Nqna_body",
			"desc": "I-Nqna_desc",
			"ovArrow": "I-Nqna_ovArrow",
			"assignRow": "I-Nqna_assignRow",
			"diagMeta": "I-Nqna_diagMeta",
			"backupCard": "I-Nqna_backupCard",
			"groupAddPanel": "I-Nqna_groupAddPanel",
			"owner": "I-Nqna_owner",
			"catsCollapsed": "I-Nqna_catsCollapsed",
			"assignSelect": "I-Nqna_assignSelect",
			"groupName": "I-Nqna_groupName",
			"setLabel": "I-Nqna_setLabel",
			"warnLine": "I-Nqna_warnLine",
			"row1": "I-Nqna_row1",
			"descTight": "I-Nqna_descTight",
			"sp": "I-Nqna_sp",
			"dot": "I-Nqna_dot",
			"barFill": "I-Nqna_barFill",
			"ovByTag": "I-Nqna_ovByTag"
		};
		//#endregion
